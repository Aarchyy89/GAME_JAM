...
public class Hola_Controller : MonoBehaviour
{
    ...
    public static Hola_Controller instance;
    [HideInInspector] public Stamina_Controller _stamina_controller;
    ...
    private void Start()
    {
        _stamina_controller = GetComponent<Stamina_Controller>();
    }
    ...
    void Update()
    {
        ...
        {
            speed = 5;
            _stamina_controller.we_Are_running = false;
        }
